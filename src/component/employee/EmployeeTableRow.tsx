...
const EmployeeTableRow: React.FC<EmployeeTableRowProps> = ({ item, index, onEdit, onDelete }) => {
  ...
  const getStatusBadge = (status: string) => {
    const statusMap = {
      active: { text: '재직', color: '#d1fae5', textColor: '#065f46' },
      inactive: { text: '퇴사', color: '#fee2e2', textColor: '#991b1b' },
      on_leave: { text: '휴직', color: '#fef3c7', textColor: '#d97706' }
    };
