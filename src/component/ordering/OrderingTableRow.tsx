...
const OrderingTableRow: React.FC<OrderingTableRowProps> = ({ item, index, onEdit, onDelete }) => {
  const getStatusBadge = (status: string) => {
    const statusMap = {
      pending: { text: '대기', color: '#f3f4f6', textColor: '#6b7280' },
      approved: { text: '승인', color: '#dbeafe', textColor: '#1e40af' },
      ordered: { text: '발주', color: '#fef3c7', textColor: '#d97706' },
      delivered: { text: '납품', color: '#d1fae5', textColor: '#065f46' },
