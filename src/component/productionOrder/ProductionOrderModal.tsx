...
interface ProductionOrderModalProps {
  ...
  formData: Partial<ProductionOrderData>;
  onClose: () => void;
  onSave: () => void;
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <h3 style={{ 
                  ...
                  {editingId ? '생산지시 정보 수정' : '새 생산지시 추가'}
                </h3>
                <p style={{ 
                  color: '#fed7aa', 
                  marginTop: '4px',
                  ...
                  {editingId ? '기존 생산지시 정보를 수정합니다' : '새로운 생산지시 정보를 입력합니다'}
                </p>
              </div>
            </div>
            <button
