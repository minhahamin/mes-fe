...
export interface BusinessApiResponse {
  ...
  export const createBusiness = async (businessData: BusinessCreateRequest): Promise<BusinessApiResponse> => {
    try {
      ...
      console.error('입고 정보 등록 실패:', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : '입고 정보 등록에 실패했습니다.'
      };
    }
  };
  
  // 입고 정보 수정 (PATCH /receipts/:id)
  export const updateBusiness = async (businessData: BusinessUpdateRequest): Promise<BusinessApiResponse> => {
    try {
      ...
      console.error('입고 정보 수정 실패:', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : '입고 정보 수정에 실패했습니다.'
      };
    }
  };
  
  // 입고 정보 삭제 (DELETE /receipts/:id)
  export const deleteBusiness = async (id: number): Promise<BusinessApiResponse> => {
    try {
      ...
      console.error('입고 정보 삭제 실패:', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : '입고 정보 삭제에 실패했습니다.'
      };
    }
  };
  
  // 입고 정보 조회 (GET /receipts)
  export const getBusinesses = async (): Promise<BusinessApiResponse> => {
    try {
      ...
      console.error('입고 정보 조회 실패:', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : '입고 정보 조회에 실패했습니다.'
      };
    }
  };
  
  // 입고 정보 단건 조회 (GET /receipts/:id)
